...
class SellVC: UIViewController {
    ...
    private func setupLayout(){
        NSLayoutConstraint.activate([
            ...
            costTextField.topAnchor.constraint(equalTo: yearTextField.bottomAnchor, constant: 15),
...
extension SellVC: UITextFieldDelegate {
...
extension SellVC: UICollectionViewDelegate, UICollectionViewDataSource {
